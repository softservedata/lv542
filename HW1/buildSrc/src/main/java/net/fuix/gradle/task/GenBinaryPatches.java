...
public class GenBinaryPatches extends DefaultTask {
    ...
    @InputFile private File             cleanClient;
    @InputFile private File             cleanServer;
    @InputFile private File             cleanMerged;
    @InputFile private File             dirtyJar;

    private List<FileTree>   patchList    = new ArrayList<FileTree>();

    @InputFile private File             deobfDataLzma;
    @InputFile private File             srg;

    @OutputFile private File             outJar;
    ...
    public void doTask() throws Exception {
        loadMappings();
        for (FileTree tree : patchList) {
            for (File patch : tree.getFiles()) {
    ...
    public File getCleanClient() { return cleanClient; }
    public void setCleanClient(File cleanClient) { this.cleanClient = cleanClient; }

    public File getCleanServer() { return cleanServer; }
    public void setCleanServer(File cleanServer) { this.cleanServer = cleanServer; }

    public File getCleanMerged() { return cleanMerged; }
    public void setCleanMerged(File cleanMerged) { this.cleanMerged = cleanMerged; }

    public File getDirtyJar() { return dirtyJar; }
    public void setDirtyJar(File dirtyJar) { this.dirtyJar = dirtyJar; }

    public void addPatchList(FileTree patchList) { this.patchList.add(patchList); }

    public File getDeobfDataLzma() { return deobfDataLzma; }
    public void setDeobfDataLzma(File deobfDataLzma) { this.deobfDataLzma = deobfDataLzma; }

    public File getOutJar() { return outJar; }
    public void setOutJar(File outJar) { this.outJar = outJar; }

    public File getSrg() { return srg; }
    public void setSrg(File srg) { this.srg = srg; }
}
